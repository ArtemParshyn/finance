    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_type', models.CharField(choices=[('individual', 'Individual'), ('company', 'Company')], default='individual', max_length=20, verbose_name='Company Type')),
                ...
                ('bic', models.CharField(blank=True, help_text='Bank Identifier Code', max_length=20, null=True, verbose_name='BIC/SWIFT')),
